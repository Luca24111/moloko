...
class DrinkCategory
{
    ...
    #[ORM\OneToMany(mappedBy: 'drinkCategory', targetEntity: Drink::class)]
    ...
    {
        return $this->name ?? 'Categoria drink';
    }
    ...
    {
        if ($this->drinks->removeElement($drink) && $drink->getDrinkCategory() === $this) {
